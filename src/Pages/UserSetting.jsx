...
useEffect(() => {
  const fetchBookings = async () => {
    try {
      ...
      const res = await fetch("https://renderbackend-g73i.onrender.com/api/user/update/my-bookings", {
  ...
  .map((b) => ({
    ...
    sport: b.ground?.sport?.name || "Unknown Sport",
    date: b.slot?.date ? new Date(b.slot.date).toISOString().split("T")[0] : "Unknown Date",
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://renderbackend-g73i.onrender.com/api/user/update/update-profile", {
  method: "PUT",
  ...
  body: JSON.stringify({ name, email }),
      ...
      if (res.ok) {
        ...
        localStorage.setItem("currentUser", JSON.stringify({ name, email, isLoggedIn: true }));
      } else {
...
const handleChangePassword = async () => {
  ...
  try {
   ...
   const res = await fetch("https://renderbackend-g73i.onrender.com/api/user/update/change-password", {
  method: "PUT",
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const res = await fetch("https://renderbackend-g73i.onrender.com/api/user/update/delete-account", {
  method: "DELETE",
  credentials: "include", // ✅ Required
});
 ...
 const handleSubmitReview = async (bookingId) => {
  ...
  try {
    const res = await fetch("https://renderbackend-g73i.onrender.com/api/reviews", {
      method: "POST",
    ...
    if (res.ok) {
      ...
      const updated = bookings.map((b) =>
        b.id === bookingId
          ? { ...b, review: { rating: reviewData.rating, comment: reviewData.comment } }
          : b
      );
      setBookings(updated);
      setExpandedReviewId(null);
...
useEffect(() => {
  ...
  console.log("Current logged in user:", JSON.parse(localStorage.getItem("currentUser")));
  ...
  <input value={email} readOnly />
        ...
        <button type="button" className="update-btn" onClick={handleChangePassword}>
          Change Password
        </button>
